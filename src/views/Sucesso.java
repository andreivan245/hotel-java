...
public class Sucesso extends JDialog {
	...
	public Sucesso() {
		...
		}
		{
			...
			{
				JButton addHospedeButton = new JButton("Adicionar outro Hóspede");
				addHospedeButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						dispose();// serve para fechar a janela atual
				...
				addHospedeButton.setActionCommand("Adicionar outro Hóspede");
				buttonPane.add(addHospedeButton);
			}
		}
	}
